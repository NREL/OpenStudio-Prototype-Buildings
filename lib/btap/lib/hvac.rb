    ...
    module HVAC # BTAP::Resources::HVAC
      ...
      module HVACTemplates
        ...
        module NECB2011
          ...
          def self.add_sys1_unitary_ac_baseboard_heating(model,mau,mau_heating_coil_type,baseboard_type,boiler_fueltype)
            ...
            # MAU is present if argument mau="Yes", not present if argument mau="No"
            ...
            if ( (mau == "Yes" and mau_heating_coil_type == "Hot Water") or baseboard_type == "Hot Water" ) then
          ...
          def self.add_sys2_FPFC_sys5_TPFC(model,boiler_fueltype,chiller_type,fan_coil_type,mua_cooling_type)
          ...
          def self.add_sys3_single_zone_packaged_rooftop_unit_with_baseboard_heating( model, heating_coil_type, baseboard_type, boiler_fueltype)
            ...
            # TO DO: need to apply this system to space types:
            #(1) conference/meeting spaces when building <= 4 storeys
            #(2) industrial spaces
            #(3) hospital spaces
            #(4) retail/general use spaces (library, bank,etc) when building <= 2 storeys
            #(5) supermarket/restaurant spaces (without kitchen exhaust hoods)
            #(6) dormitory spaces
          ...
          def self.add_sys4_single_zone_make_up_air_unit_with_baseboard_heating( model, heating_coil_type, baseboard_type, boiler_fueltype)
          ...
          def self.add_sys5_two_pipe_fane_coil( model )
            #Todo
          end
...
#            pump.setPumpFlowRateSchedule(pump_flow_sch)
          ...
          def self.setup_chw_loop_with_components(model,chw_loop,chiller_type)
            ...
            eir_f_of_avail_to_nom_cap = OpenStudio::Model::CurveBiquadratic.new(model)
            eir_f_of_plr = OpenStudio::Model::CurveQuadratic.new(model)
            if(chiller_type == "Scroll")
              clg_cap_f_of_temp.setCoefficient1Constant(0.94418)
              clg_cap_f_of_temp.setCoefficient2x(0.0337102)
              clg_cap_f_of_temp.setCoefficient3xPOW2(0.0000975564)
              clg_cap_f_of_temp.setCoefficient4y(-0.00322114)
              clg_cap_f_of_temp.setCoefficient5yPOW2(-0.0000491832)
              clg_cap_f_of_temp.setCoefficient6xTIMESY(-0.000177584)
              eir_f_of_avail_to_nom_cap.setCoefficient1Constant(7.27393E-01)
              eir_f_of_avail_to_nom_cap.setCoefficient2x(-1.18922E-02)
              eir_f_of_avail_to_nom_cap.setCoefficient3xPOW2(5.41177E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient4y(1.87934E-03)
              eir_f_of_avail_to_nom_cap.setCoefficient5yPOW2(4.73461E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient6xTIMESY(-7.11472E-04)
              eir_f_of_plr.setCoefficient1Constant(0.04411957)
              eir_f_of_plr.setCoefficient2x(0.64036703)
              eir_f_of_plr.setCoefficient3xPOW2(0.31955532)
            elsif(chiller_type == "Reciprocating")
              clg_cap_f_of_temp.setCoefficient1Constant(1.03031)
              clg_cap_f_of_temp.setCoefficient2x(0.0334698)
              clg_cap_f_of_temp.setCoefficient3xPOW2(0.00023639)
              clg_cap_f_of_temp.setCoefficient4y(-0.00729587)
              clg_cap_f_of_temp.setCoefficient5yPOW2(-0.000023166)
              clg_cap_f_of_temp.setCoefficient6xTIMESY(-0.000148943)
              eir_f_of_avail_to_nom_cap.setCoefficient1Constant( 4.99699E-01)
              eir_f_of_avail_to_nom_cap.setCoefficient2x(-1.30841E-02)
              eir_f_of_avail_to_nom_cap.setCoefficient3xPOW2(2.66425E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient4y(1.65925E-02)
              eir_f_of_avail_to_nom_cap.setCoefficient5yPOW2(1.85393E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient6xTIMESY(-3.75646E-04)
              ...
              clg_cap_f_of_temp.setCoefficient4y(0.0263844)
              clg_cap_f_of_temp.setCoefficient5yPOW2(-0.00091543)
              clg_cap_f_of_temp.setCoefficient6xTIMESY(0.00169601)
              eir_f_of_avail_to_nom_cap.setCoefficient1Constant(6.38103E-01)
              eir_f_of_avail_to_nom_cap.setCoefficient2x(6.30158E-03)
              eir_f_of_avail_to_nom_cap.setCoefficient3xPOW2(9.23270E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient4y(-4.55294E-03)
              eir_f_of_avail_to_nom_cap.setCoefficient5yPOW2(8.25682E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient6xTIMESY(-1.56152E-03)
              eir_f_of_plr.setCoefficient1Constant(0.33018833)
              eir_f_of_plr.setCoefficient2x(0.23554291)
              eir_f_of_plr.setCoefficient3xPOW2(0.46070828)
            elsif(chiller_type == "Centrifugal")
              clg_cap_f_of_temp.setCoefficient1Constant(0.707908)
              clg_cap_f_of_temp.setCoefficient2x(-0.00200657)
              clg_cap_f_of_temp.setCoefficient3xPOW2(-0.00259605)
              clg_cap_f_of_temp.setCoefficient4y(0.0300588)
              clg_cap_f_of_temp.setCoefficient5yPOW2(-0.00105643)
              clg_cap_f_of_temp.setCoefficient6xTIMESY(0.0020457)
              eir_f_of_avail_to_nom_cap.setCoefficient1Constant(5.60523E-01)
              eir_f_of_avail_to_nom_cap.setCoefficient2x(-1.37816E-02)
              eir_f_of_avail_to_nom_cap.setCoefficient3xPOW2(6.56424E-05)
              eir_f_of_avail_to_nom_cap.setCoefficient4y(1.32194E-02)
              eir_f_of_avail_to_nom_cap.setCoefficient5yPOW2(2.68596E-04)
              eir_f_of_avail_to_nom_cap.setCoefficient6xTIMESY(-5.01131E-04)
              eir_f_of_plr.setCoefficient1Constant(0.17149273)
              eir_f_of_plr.setCoefficient2x(0.58820208)
              eir_f_of_plr.setCoefficient3xPOW2(0.23737257)
            end
            clg_cap_f_of_temp.setMinimumValueofx(5.0)
            clg_cap_f_of_temp.setMaximumValueofx(10.0)
            clg_cap_f_of_temp.setMinimumValueofy(24.0)
