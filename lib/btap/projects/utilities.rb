...
class Utilities
  ...
  #This method will bring up Kdiff3 for a 2 or 3-way diff view of the OSM file.
  ...
  #this method will take a path to a idf file and save a fully sorted idf file with the suffix ".sorted" in the same folder.
