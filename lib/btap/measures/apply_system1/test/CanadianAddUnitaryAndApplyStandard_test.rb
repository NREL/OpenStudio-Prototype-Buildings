...
#      BTAP::Resources::HVAC::HVACTemplates::NECB2011::assign_zones_sys1(model, model.getThermalZones, boiler_fueltypes[0], mau_types[1], mau_heating_coil_types[0], baseboard_types[0])
...
#      model = BTAP::FileIO::load_osm("#{File.dirname(__FILE__)}/5ZoneNoHVAC.osm")
#      BTAP::Environment::WeatherFile.new("#{File.dirname(__FILE__)}/../../../weather/CAN_ON_Toronto.716240_CWEC.epw").set_weather_file(model)
#      BTAP::Resources::HVAC::HVACTemplates::NECB2011::assign_zones_sys3(model, model.getThermalZones, boiler_fueltypes[0], heating_coil_types_sys3[0], baseboard_types[0])
#      run_the_measure(model)
