...
require "#{File.dirname(__FILE__)}/btap_create_doe_necb_models/tests/DOE2NECB_Model_Test.rb"
require "#{File.dirname(__FILE__)}/btap_apply_necb_rules/tests/apply_necb_rules_Test.rb"
require "#{File.dirname(__FILE__)}/UtilityTariffs/tests/UtilityTariffs_Test.rb"
require "#{File.dirname(__FILE__)}/btap_campus_classic/test/btap_coldlake_classic_test.rb"
require "#{File.dirname(__FILE__)}/apply_system1/test/full_hvac_test.rb"
