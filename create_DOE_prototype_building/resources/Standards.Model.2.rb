...
class OpenStudio::Model::Model
  ...
  def add_material(material_name)
    ...
    if material_type == 'StandardOpaqueMaterial'
      ...
      puts "back_side_solar_reflectance_at_normal_incidence"
      puts data['back_side_solar_reflectance_at_normal_incidence'].to_f
      puts material.getBackSideSolarReflectanceatNormalIncidence().get.to_s
  ...
  def find_and_add_construction(template, climate_zone_set, intended_surface_type, standards_construction_type, building_category)
    ...
    props = self.find_object(@standards['construction_properties'], {'template'=>template,
