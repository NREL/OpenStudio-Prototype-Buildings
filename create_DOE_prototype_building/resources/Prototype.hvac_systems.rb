...
class OpenStudio::Model::Model
  ...
  def add_vav(prototype_input, hvac_standards, hot_water_loop, chilled_water_loop, thermal_zones)
    ...
    if oa_node.is_initialized
      ...
      OpenStudio::logFree(OpenStudio::Error, "openstudio.prototype.Model", "No outdoor air node found, can not add heat exchanger")
      return false
    end
    ...
    thermal_zones.each do |zone|
      ...
      if prototype_input["hx"] == true
        ...
        if oa_node.is_initialized
          ...
          OpenStudio::logFree(OpenStudio::Info, "openstudio.prototype.Model", "No outdoor air node found, can not add heat exchanger")
          return false
        end
      end
