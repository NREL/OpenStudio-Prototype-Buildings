  ...
  def define_space_type_map(building_type, building_vintage, climate_zone)
    ...
    when '90.1-2010'
      space_type_map = {
        ...
        'Storage' => ['FrontStorageFlr1','FrontStorageFlr2','FrontStorageFlr3','FrontStorageFlr4',
                      'RearStorageFlr1','RearStorageFlr2','RearStorageFlr3','RearStorageFlr4'],
        'GuestRoomOcc' => ['GuestRoom103','GuestRoom104','GuestRoom105','GuestRoom202_205','GuestRoom206_208',
                        ...
                        'GuestRoom401','GuestRoom409_412','GuestRoom415_418','GuestRoom419','GuestRoom420_423','GuestRoom424'],
        'GuestRoomVac' => ['GuestRoom101','GuestRoom102','GuestRoom201','GuestRoom215_218','GuestRoom301',
                          'GuestRoom302_305','GuestRoom306_308','GuestRoom313','GuestRoom319','GuestRoom324',
                          'GuestRoom402_405','GuestRoom406_408','GuestRoom413','GuestRoom414',],
        'Laundry' => ['LaundryRoomFlr1'],
        'Mechanical' => ['MechanicalRoomFlr1','ElevatorCoreFlr2','ElevatorCoreFlr3','ElevatorCoreFlr4'],  #TODO
        'Meeting' => ['MeetingRoomFlr1'],
        'PublicRestroom' => ['RestroomFlr1'],
